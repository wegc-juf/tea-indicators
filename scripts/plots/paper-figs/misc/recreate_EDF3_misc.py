...
def ylims(opts, vname):
    ...
    if opts.region == 'SEA' and opts.threshold == 30:
        params = {'EF_GR': {'yx': 18, 'dy': 2},
                  'EDavg_GR': {'yx': 8, 'dy': 2},
                  'EMavg_GR': {'yx': 2, 'dy': 0.5},
                  'EAavg_GR': {'yx': 100, 'dy': 20},
                  'TEX_GR': {'yx': 6000, 'dy': 1000}}
    elif opts.region == 'SEA' and opts.threshold == 25:
        params = {'EF_GR': {'yx': 30, 'dy': 5},
                  'EDavg_GR': {'yx': 12, 'dy': 2},
                  'EMavg_GR': {'yx': 4, 'dy': 0.5},
                  'EAavg_GR': {'yx': 125, 'dy': 25},
                  'TEX_GR': {'yx': 30000, 'dy': 5000}}
    else: # AUT 30degC
        params = {'EF_GR': {'yx': 18, 'dy': 2},
                  'EDavg_GR': {'yx': 8, 'dy': 2},
                  'EMavg_GR': {'yx': 2, 'dy': 0.5},
                  'EAavg_GR': {'yx': 500, 'dy': 100},
                  'TEX_GR': {'yx': 45000, 'dy': 5000}}
