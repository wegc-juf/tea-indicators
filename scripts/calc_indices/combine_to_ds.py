...
def create_em_ds(opts, em, em_gr, em_avg, em_avg_gr, em_avg_med, em_avg_gr_med, em_med, em_gr_med,
    ...
    em_gr_avg_max = em_gr_avg_max.rename('EM_Max_avg_GR')
